...
public class KaryawanPanel extends javax.swing.JPanel {
    ...
    private void loadData() {
        ...
        // Get all sopir data
        List<Karyawan> karyawanList = karyawanController.getAllKaryawan();
    ...
    private void tableRowSelected() {
        ...
        if (selectedRow != -1) {
            ...
            int idKaryawan = Integer.parseInt(tableModel.getValueAt(selectedRow, 0).toString());
            ...
            txtid.setText(String.valueOf(idKaryawan));
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory
                .createTitledBorder(javax.swing.BorderFactory.createTitledBorder("Tabel Karyawan")));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Form Karyawan"));
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel3Layout
                                                ...
                                                .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 145,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                                ...
                                                .addComponent(jRadioButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 80,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String reportPath = "./src/report/ReportKaryawan.jasper";
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btntambahActionPerformed
        try {
            ...
            if (txtnama.getText().trim().isEmpty()
                ...
                JOptionPane.showMessageDialog(this, "Semua field harus diisi dan role harus dipilih!",
                        "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            String role = jRadioButton1.isSelected() ? "admin" : "staff";

            // Call controller to add karyawan
            boolean success = karyawanController.addKaryawan(nama, username, password, role);
            ...
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
            System.err.println("Error menambahkan karyawan: " + e.getMessage());
        }
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btneditActionPerformed
        try {
            ...
            // Get values from form
            int idKaryawan = Integer.parseInt(txtid.getText().trim());
            String nama = txtnama.getText().trim();
            String username = txtusername.getText().trim();
            String password = txtpassword.getText().trim();
            String role = jRadioButton1.isSelected() ? "admin" : "staff";

            // Update karyawan data first
            boolean success = karyawanController.updateKaryawan(idKaryawan, nama, username, role);

            // Update password separately
            if (success) {
                success = karyawanController.updatePassword(idKaryawan, password);
            }
            ...
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
            System.err.println("Error mengedit karyawan: " + e.getMessage());
        }
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnhapusActionPerformed
        try {
            ...
            // Confirm deletion
            int confirm = JOptionPane.showConfirmDialog(this, "Anda yakin ingin menghapus data karyawan ini?",
                    "Konfirmasi Hapus", JOptionPane.YES_NO_OPTION);

            if (confirm == JOptionPane.YES_OPTION) {
                int idKaryawan = Integer.parseInt(txtid.getText().trim());

                // Call controller to delete karyawan
                boolean success = karyawanController.deleteKaryawan(idKaryawan);
            ...
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
            System.err.println("Error menghapus karyawan: " + e.getMessage());
        }
